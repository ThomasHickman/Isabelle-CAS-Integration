...
ode_solve_thm "(λ ind (x, t). (c+b*(u-x), 1))" UNIV UNIV "b > 0"
ode_solve_thm "(λ ind (dP, ptimer). (dPv, 0.002))"
...
ode_solve_thm "(λ ind (x1, x2, d1, d2, y1, y2, e1, e2). (d1, d2, -om*d2, om*d1, e1, e2, -om*e2, om*e1))" UNIV UNIV "om > 0"
ode_solve_thm "(λ ind (x, v, t). (v, a, 1))"
...
ode_solve_thm "(λ ind (x, y, vx, vy). (vx, vy, -a * vy, a * vx))" UNIV UNIV "a > 0"
